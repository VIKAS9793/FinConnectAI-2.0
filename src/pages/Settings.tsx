      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
          <div className="p-5 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">Configure the fraud explainer agent settings</p>
          </div>
          
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="fraudConfidence" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  ...
                  onChange={(e) => handleSettingChange('fraudExplainer', 'confidenceThreshold', parseInt(e.target.value))}
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                />
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-gray-500">50%</span>
                  <span className="text-xs font-medium">{settings.fraudExplainer.confidenceThreshold}%</span>
                  <span className="text-xs text-gray-500">95%</span>
                </div>
              </div>
              
              <div>
                <label htmlFor="fraudResponseTime" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  ...
                  onChange={(e) => handleSettingChange('fraudExplainer', 'maxResponseTime', parseInt(e.target.value))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              
              <div>
                <label htmlFor="fraudModel" className="block text-sm font-medium text-gray-700 mb-1">
                  Model Version
                </label>
                <select
                  id="fraudModel"
                  value={settings.fraudExplainer.modelVersion}
                  onChange={(e) => handleSettingChange('fraudExplainer', 'modelVersion', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) => handleSettingChange('fraudExplainer', 'enablePiiMasking', e.target.checked)}
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
          <div className="p-5 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">Configure the risk profile generator agent settings</p>
          </div>
          
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="riskConfidence" className="block text-sm font-medium text-gray-700 mb-1">
                  Confidence Threshold (%)
                </label>
                <input
                  type="range"
                  ...
                  onChange={(e) => handleSettingChange('riskProfileGenerator', 'confidenceThreshold', parseInt(e.target.value))}
                  className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                />
                <div className="flex justify-between mt-1">
                  <span className="text-xs text-gray-500">50%</span>
                  <span className="text-xs font-medium">{settings.riskProfileGenerator.confidenceThreshold}%</span>
                  <span className="text-xs text-gray-500">95%</span>
                </div>
              </div>
              
              <div>
                <label htmlFor="riskResponseTime" className="block text-sm font-medium text-gray-700 mb-1">
                  Max Response Time (seconds)
                </label>
                <input
                  type="number"
                  ...
                  onChange={(e) => handleSettingChange('riskProfileGenerator', 'maxResponseTime', parseInt(e.target.value))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleSettingChange('riskProfileGenerator', 'modelVersion', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
                  <option value="mistral">Mistral</option>
                  <option value="phi3">Phi-3</option>
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) => handleSettingChange('riskProfileGenerator', 'enableAutoUpdates', e.target.checked)}
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                />
